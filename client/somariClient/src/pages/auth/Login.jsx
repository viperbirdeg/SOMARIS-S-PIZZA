...
export default function Login() {
    ...
    return (
        <div className="padre">
            ...
            <div className="min-h-screen bg-[#E0E0E0] flex items-center justify-center px-4 login">
                <div className="w-full max-w-4xl bg-white rounded-2xl shadow-lg overflow-hidden grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="relative flex flex-col justify-center px-10 py-12">
                        <button
                            onClick={() => navigate("/")}
                            className="absolute top-6 left-6 flex items-center gap-2 text-sm text-[#212121] hover:text-[#B71C1C] transition cursor-pointer"
                        >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="flex justify-end">
                                <button
                                    type="button"
                                    className="text-sm text-[#212121] hover:text-[#B71C1C] transition cursor-pointer"
                                >
                            ...
                            <button
                                type="submit"
                                className="cursor-pointer w-full bg-[#B71C1C] text-white py-3 rounded-md font-semibold hover:bg-[#9f1818] transition shadow-md"
                            >
                                Iniciar sesión
                            </button>
                        </form>
                        ...
                        <p className="mt-8 text-sm text-center text-gray-600">
                            ...
                            <button
                                ...
                                className="font-semibold text-[#212121] hover:text-[#B71C1C] transition cursor-pointer"
                            >
                                Regístrate
                            </button>
                        </p>
